...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="task-section__checkbox";
    editInput.type="text";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task-section__item_editmode");
    //If class of the parent is .task-section__item_editmode
    if(containsClass){

        //switch to .task-section__item_editmode
    ...
    //toggle .task-section__item_editmode on the parent.
    listItem.classList.toggle("task-section__item_editmode");
};
